...
def indexTwo():
    """Video streaming home page."""
    return render_template('html/index-two.html')
...
def gen(data=None):
    ...
    while True:
        ...
        cv2.imwrite('streaming.png', frame)
        yield (b'--frame\r\n'
               b'Content-Type: image/jpg\r\n\r\n' + open('streaming.png', 'rb').read() + b'\r\n')

        if cont == 100:
            faces = []
            face_actaul = recoding(frame)
            for path, diretorios, arquivos in walk('images'):
